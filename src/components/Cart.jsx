                    ...
                    <form onSubmit={handleCheckout} className="space-y-4">
                      ...
                      <div className="mt-6">
                        <motion.button
                          ...
                          type="submit"
                          disabled={sending}
                          className="w-full flex items-center justify-center gap-2 bg-corporativo hover:bg-dorado hover:text-corporativo text-white py-3 rounded-lg font-bold uppercase tracking-wider transition-all duration-300 shadow-md disabled:opacity-60"
                        >
                          <Send size={16} />
